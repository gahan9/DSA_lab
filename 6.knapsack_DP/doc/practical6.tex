...
% Practical 6: 0/1 Knapsack Problem with Dynamic Programming
%
% Gahan M. Saraiya
% 18MCEC10
%
...
\title{\vspace{-15mm}\fontsize{24pt}{10pt}\selectfont\textbf{
		\underline{Practical 6}\\Implementation of 0/1 Knapsack with dynamic programming}} % Article title
\author{\large{\textsc{
...
\subsection{Main Program - \textbf{\textit{knapsack\_DP.c}}}
\inputminted[frame=lines, breaklines, linenos]{c}{../knapsack_DP.c}
