...
% Practical 5 B: Implementation of Recursive Exponential algorithm using Divide and Conquer Approach
%
% Gahan M. Saraiya
% 18MCEC10
%
...
\title{\vspace{-15mm}\fontsize{24pt}{10pt}\selectfont\textbf{
		\underline{Practical 5 B}\\Implementation of Recursive Exponential algorithm using Divide and Conquer Approach}} % Article title
\author{\large{\textsc{
...
\inputminted[frame=lines, breaklines, linenos]{c}{../recursive_exponential.c}
