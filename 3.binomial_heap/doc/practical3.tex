...
% Practical 3: Implementation of Binomial Heap
%
% Gahan M. Saraiya
% 18MCEC10
%
...
\title{\vspace{-15mm}\fontsize{24pt}{10pt}\selectfont\textbf{
		\underline{Practical 3}\\Implementation of Binomial Heap}} % Article title
\author{\large{\textsc{
...
\subsection{Main Program - \textbf{\textit{binomial\_heap.c}}}
\inputminted[frame=lines, breaklines, linenos]{c}{../binomial_heap.c}
